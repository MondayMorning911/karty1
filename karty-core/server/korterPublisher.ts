...
Если из текста непонятно, просто верните null для этого поля. НЕ ВЫДУМЫВАЙТЕ ДАННЫЕ.

Поля для JSON:
- dealType: "Продажа" | "Долгосрочная аренда" | "Посуточная аренда" (если не указано, null)
- propertyType: "Квартира" | "Дом" | "Коммерческая недвижимость" | "Участок" | "Гаражи и паркинги" (если не указано, null)
...
- city: Город (если не указано, null)
- street: Название улицы (если нет, null)
- houseNumber: Номер дома (если нет, null)
- floor: Этаж (если нет, null)
- floorCount: Этажность дома (если нет, null)
- rooms: Количество комнат (от 1 до 5, если не указано - null)
- bedrooms: Количество спален (от 1 до 4, если не указано - null)
- bathrooms: Количество санузлов (от 1 до 3, если не указано - null)
- area: Общая площадь (число, если не указано - null)
- price: Цена в долларах (число, если не указано - null)
