...
ПРАВИЛО ДЛЯ СПАЛЕН: Если спальни не указаны явно, то они равны Количество комнат минус 1 (минимум 0, но на сайте минимум 1). Если комната 1 (студия), то спален 1.
...
- Если спален нет и комнат нет, добавьте "Количество спален"
